    ...
    <div style="width: 70%; margin: 30px auto">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          <el-table-column prop="id" label="序号" width="250" align="center" sortable></el-table-column>
          ...
          <el-table-column prop="name" label="课程名称" show-overflow-tooltip width="200">
          </el-table-column>
          ...
          <el-table-column label="进入课程">
            <template v-slot="scope">
              <a :href="'/front/courseDetail?id=' + scope.row.id" style="color: #3f9dfb; text-decoration: none">点击进入</a>
            </template>
          </el-table-column>
