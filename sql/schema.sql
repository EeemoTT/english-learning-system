...
CREATE TABLE `course` (
  ...
  `video` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '课程视频',
  `file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '课程资料',
...
CREATE TABLE `question` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '题目名称',
  ...
  `detail` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '解析',
  PRIMARY KEY (`id`)
...
CREATE TABLE `sign_in` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID',
  `time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '签到时间',
  `day` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '签到当天时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `target` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` int DEFAULT NULL COMMENT '用户id',
  `book` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '学习单词书',
...
CREATE TABLE `test` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '考试名称',
...
CREATE TABLE `user_paper` (
  ...
  `paper` text COLLATE utf8mb4_unicode_ci COMMENT '试卷内容',
...
CREATE TABLE `word` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `word` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '单词',
  `ukphone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '音标',
  `tran` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '翻译',
...
-- Dump completed on 2026-02-23 11:00:35
